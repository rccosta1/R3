    ...
    : RModel(parent, name)
{
    ...
    theTenure = QString("OwnerOccupied");
...
QObject * RSimpleBuildingDamageModel::getLocation() const
{
    return theLocation;
}

void RSimpleBuildingDamageModel::setLocation(QObject *value)
{
...
QString RSimpleBuildingDamageModel::getBuildingType()
{
    return theBuildingType;
}


void RSimpleBuildingDamageModel::setBuildingType(QString value)
{
    theBuildingType = value;
}


QString RSimpleBuildingDamageModel::getCodeDesignLevel()
{
    return theCodeDesignLevel;
}

void RSimpleBuildingDamageModel::setCodeDesignLevel(QString value)
{
...
int RSimpleBuildingDamageModel::getNumberOfStoreys() const
{
    return theNumberOfStoreys;
}

void RSimpleBuildingDamageModel::setNumberOfStoreys(int value)
{
    theNumberOfStoreys = value;
}


QString RSimpleBuildingDamageModel::getOccupancyClass() const
{
    return theOccupancyClass;
}

void RSimpleBuildingDamageModel::setOccupancyClass(QString value)
{
...
int RSimpleBuildingDamageModel::evaluateModel()
{
    ...
    //qCritical() << "The structural damage ratio is:" << damageRatioS << "for a drift of:" << drift;
    ...
    if (theBuildingType.contains("C")) {
        pIrreparability = theProbabilityDistributions.getNormalCDF((1.0 / 0.3) * log(Dr / 1.0), 1);
    }

    double  rngReparability = rand()/static_cast<double>(RAND_MAX);
