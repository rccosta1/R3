...
QObject* RResidentialMobilityNeighborhoodModel::getDisplacementEstimator()
{
    return theDisplacementEstimator;
}

void RResidentialMobilityNeighborhoodModel::setDisplacementEstimator(QObject *value)
{
    theDisplacementEstimator = qobject_cast<RPopulationDisplacementEstimator*>(value);
}

QString RResidentialMobilityNeighborhoodModel::getContractorList()
{
    return parameterListToString(theContractorList);
}

void RResidentialMobilityNeighborhoodModel::setContractorList(QString value)
{
    theContractorList = stringToParameterList(value);
}

QString RResidentialMobilityNeighborhoodModel::getFinancialResourcesSupplierList()
{
    return parameterListToString(theFinancialResourcesSupplierList);
}

void RResidentialMobilityNeighborhoodModel::setFinancialResourcesSupplierList(QString value)
{
...
int RResidentialMobilityNeighborhoodModel::evaluateModel()
{
    ...
    // --------------------------------------------------------------------------------------
    // 5 - Handle packets delivered on this time step
    // --------------------------------------------------------------------------------------
                ...
                for (int j = 0; j < theBuildingNumberOfDwellings.at(ii); j++){
                    ...
                    if (theBuildingOccupancyClass.at(ii) == QString("RES1") && alreadyRequestedFinancing.at(ii) == false){
                        ...
                        if (skipFunding == true){
                            ...
                            theBuildingAmountLendedFromBank[ii] += theImmediateEconomicLoss.at(ii);
                            ...
                            if (theBuildingOccupancyClass.at(ii) == QString("RES1")){
                                ...
                                if (theHouseholdTenureStatus.at(ii).at(j) == QString("OwnerOccupied")){
                                    ...
                                    if (rngInsurance < 0.15){
                                        ...
                                        theTimeNeededToGetFunding[ii] += theDelaysFromInsurance;
                                    }
                                    ...
                                    if (theBuildingOwnerIncome.at(ii) == QString("High")){
                                        ...
                                        if (theHouseholdMortgage.at(ii).at(j) == false) {
                                            ...
                                            thePrivateRequestID << ii;
                                            numberOfBankLoans++;
                                            theTimeNeededToGetFunding[ii] += theDelaysFromBank;
                                        ...
                                        if (theBuildingExpectedFunds.at(ii) < theImmediateEconomicLoss.at(ii)){
                                            ...
                                            if (rngSBALoan <= 0.47){
                                                ...
                                                numberOfSBALoans++;
                                                theTimeNeededToGetFunding[ii] += theDelaysFromSBA;
                                                ...
                                                if (theBuildingExpectedFunds.at(ii) < theImmediateEconomicLoss.at(ii)){
                                                    ...
                                                    if (theBuildingExpectedFunds.at(ii) < theImmediateEconomicLoss.at(ii)){
                                                        ...
                                                        numberOfCDBGDRGrants++;
                                                        theTimeNeededToGetFunding[ii] += theDelaysFromCDBG;
                                                    } // CDBG
                                                } // SBA and Bank
                                    ...
                                    if (rngBankLoan < 0.91) {
                                        ...
                                        theBuildingAmountLendedFromBank[ii] += theImmediateEconomicLoss.at(ii) - theBuildingExpectedFunds.at(ii);
                                        theBuildingExpectedFunds[ii] += theImmediateEconomicLoss.at(ii) - theBuildingExpectedFunds.at(ii);
                                        theTimeNeededToGetFunding[ii] += 2.0 * theDelaysFromBank;
                                    } //
                                ...
                                theBuildingAmountMissing[ii] = qMax(theImmediateEconomicLoss[ii] - theBuildingExpectedFunds[ii],0.0);
                                if (theBuildingAmountMissing.at(ii) > 0.0){
                                    numberOfHouseholdsMissingFunds++;
                                }

                                double theSavings = 0.0;
                                theSavings = theBuildingAmountMissing[ii];
                                ...
                                if (theBuildingAvailableFunds.at(i) >= theImmediateEconomicLoss.at(i)){
                                    theTimeNeededToGetFunding[ii] += theRNG.generateDouble() * 180.0;
                                }
...
//                theInsuranceRequest->setRequestedAmountList(qMax(theImmediateEconomicLoss.at(theID) - 0.15 * theBuildingValue.at(theID),0.0)+1.0);
...
//                thePublicLoanRequest->setRequestedAmountList(theBuildingAmountLendedFromSBA.at(theID)+1.0);
...
//                theGrantRequest->setRequestedAmountList(theBuildingAmountGrantedByCDBGDR.at(theID)+1.0);
//                theGrantRequest->setRequesterOccupancyType(theHouseholdTenureStatus.at(theID).at(0));
//                totalGrantMoneyRequest += theBuildingAmountGrantedByCDBGDR.at(theID);
//            }
//        }
