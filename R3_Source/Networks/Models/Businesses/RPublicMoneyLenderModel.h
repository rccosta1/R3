#ifndef RPublicMoneyLenderModel_H
#define RPublicMoneyLenderModel_H
...
class RPublicMoneyLenderModel : public RNetworkModel
{
...
public:
    ...
    RPublicMoneyLenderModel(QObject *parent, QString name);
    ~RPublicMoneyLenderModel();
